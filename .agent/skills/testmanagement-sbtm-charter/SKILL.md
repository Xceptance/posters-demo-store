...
2. **Review Templates & Guidelines:** Read `test-management/sbtm/CHARTER_TEMPLATE.md` to understand the required format, and `test-management/sbtm/GUIDELINES.md` for context on SBTM rules.
3. **Draft the Charter:** 
...
5. **Save the Artifact:** Once the user approves, save the charter to `test-management/sbtm/[coverage-area]/charters/CHARTER-[ID]-[Title-Slug].md`. Make sure to create the directories if they do not exist.
