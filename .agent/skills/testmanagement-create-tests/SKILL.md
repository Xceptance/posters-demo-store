...
4. **ISTQB Validation:** Automatically run coverage grades against standard quality models. Save or update this review report directly in the target domain folder (e.g., `doc/tests/DOMAIN/ISTQB_REVIEW.md`) using the exact format defined in `doc/tests/TEMPLATE_ISTQB_REVIEW.md`, and provide feedback to the user.
