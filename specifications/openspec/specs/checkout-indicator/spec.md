# Checkout Indicator Spec

## 1. Overview
A visual progress indicator displayed at the top of the checkout flow to orient the user through the multi-step process.

## 2. Requirements

### 2.1. Checkout Indicator Rendering
