...
- [ ] BUS-BUG-26: Backoffice Dashboard displays unauthorized module welcome cards — Users logged in with restricted roles (e.g., Customer Admin or Catalog User) see all four module cards in the welcome dashboard on landing at `/backoffice/`, even though they only have permission for one, instead of only seeing the card(s) they have permission to access.
