...
public class Routes implements ApplicationRoutes {
	...
	public void init(Router router) {
		...
		router.POST().route("/addPaymentToCustomerCompleted").with(CustomerController.class, "addPaymentToCustomerCompleted");
...
//		router.GET().route("/addressOverview").with(WebShopController.class, "addressOverview");
		...
		// basket
		router.POST().route("/addToCart").with(BasketController.class, "addToCart");
