...
public class CustomerController {
	...
	/**
	 * Logs on to the system with email and password. Returns the home page, if
	 * the email and the password are correct, otherwise an error page.
	 * 
	 * @param email
	 * @param password
	 * @param context
	...
	/**
	 * Starts a registration to get an account. Returns the page to enter
	 * account information.
	 * 
	 * @param context
	 * @return
	...
	public Result addPaymentToCustomerCompleted(
		...
		// return info page
		return Results.html().render(data)
				.template("views/info/savingComplete.ftl.html");
	}
	...
	public Result deletePayment(@Param("cardId") int cardId, Context context) {
		...
		customer.deleteCreditCard(CreditCardInformation
