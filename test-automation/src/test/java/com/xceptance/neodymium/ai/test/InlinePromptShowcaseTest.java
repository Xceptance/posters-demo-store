...
/**
 * Prompt defined directly in Java.
 * No data file is used. The AI agent executes the provided string.
 * Demonstrates the use of the fluent API for before/after/system context and the prompt itself.
 */
...
public class InlinePromptShowcaseTest
{
    ...
    void testWithPromptDirectlyInJava() throws Throwable
    {
        Neodymium.ai()
            ...
            .before("Navigate to ${neodymium.url}")
                 .prompt("Verify the site contains 'Posters'")
            .after("Clear cookies")
            .execute();
    }
    ...
    {
        // You can push data to Neodymium's context so it can be resolved in the prompt.
