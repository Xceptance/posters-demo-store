...
| :--- | :--- | :--- | :--- | :--- |
| [TC_ACC_001](./TC_ACC_001.md) | Successful Account Registration | 🔴 Critical | Smoke, Regression | Verify user can register with valid data. |
...
| [TC_ACC_008](./TC_ACC_008.md) | Robust Input Processing and Localization | 🟠 High | Regression | Verify whitespace trimming (names/email), case-insensitivity, and internationalized inputs. |
